...
occurrences of these integers in the array. Return the minimum size of the set 
...
'''
ALGORITHM:
1. Count occurances of every element and store in hashmap.<key>:<count> 
2. Copy all count values into an array cnt_arr and sort this array. 
3. Starting from most highest value in cnt_arr, remove elements, till left 
   elements are less than half. 
