...
'''
ALGORITHM:
1. Keep track of number of orders processed and apply discount for every nth
   order
RUNTIME COMPLEXITY: O(P) for bill of P products. 
SPACE COMPLEXITY: O(M) to store prices of M products
'''
...
class Cashier(object):
    ...
    def getBill(self, product, amount):
        ...
        for i in range(len(product)):
            ...
            total += self.prices[product_id] * amount[i]
