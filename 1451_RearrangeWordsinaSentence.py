...
2. Maintain a dictionary with length and words of that length in the order they
   appear. 
3. Sort the lengths in ascending order. 
4. Reconstruct the text using sorted lengths and the dictionary. 

RUNTIME COMPLEXITY: O(NLogN) for n words in text
SPACE COMPLEXITY: O(M) for m characters in text
'''
