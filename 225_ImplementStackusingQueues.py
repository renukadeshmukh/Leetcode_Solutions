...
'''
ALGORITHM:
Use deque (double ended queue) from python library to push and pop from right
'''
...
class MyStack:
    ...
    def push(self, x):
        ...
        :rtype: void
        """
        self.double_ended_queue.append(x)
    ...
    def pop(self):
        ...
        :rtype: int
        """
        return self.double_ended_queue.pop()
    ...
    def top(self):
        ...
        :rtype: int
        """
        return self.double_ended_queue[-1]
    ...
    def empty(self):
        ...
        :rtype: bool
        """
        return len(self.double_ended_queue) == 0
