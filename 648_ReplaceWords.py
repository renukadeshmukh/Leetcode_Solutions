...
class Solution(object):
    def replaceWords(self, dict1, sentence):
        """
        :type dict: List[str]
        :type sentence: str
        :rtype: str
        ...
        res = []
        for word in words:
            res.append(lookup[word])

        return ' '.join(res)

s = Solution()
res = s.replaceWords(["a", "aa", "aaa", "aaaa"], "a aa a aaaa aaa aaa aaa aaaaaa bbb baba ababa")
print(res)
