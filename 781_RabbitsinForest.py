...
are placed in an array. Return the minimum number of rabbits that could be in 
the forest.
...
Say the rabbit that answered "2" was blue. Then there should be 2 other blue 
rabbits in the forest that didn't answer into the array.
